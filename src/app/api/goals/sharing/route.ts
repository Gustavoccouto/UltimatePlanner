...
export async function POST(request: Request) {
  ...
  try {
    ...
    const access = await assertCanManageSharing(context.supabase, "goal", payload.goal_id, context.user.id);
    ...
    if (payload.action === "remove") {
      ...
      await createActivityLog(context.supabase, {
        ...
        entityType: "goal",
        entityId: payload.goal_id,
        actionType: "goal_share_removed",
